        ...
        <div className="bg-black py-16 sm:py-24">
            <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32  sm:rounded-3xl">
                    ...
                    src={beatbikeStrong}
                    alt="Beatbike Strong!"
                    className="absolute inset-0 -z-10 h-full w-full object-center object-cover md:object-center"
                    />
                    ...
                    />
                        ...
                        <div className={mulish.className}>
                            <p className="mx-auto mt-2 max-w-xl text-center text-lg leading-8 text-[#DFFF00] bg-[#333333] px-4 rounded-lg">
                        ...
                        <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
                            <form className="mx-auto mt-10 flex max-w-md gap-x-4" action={createSubscriber} >
                                ...
                                <input
                                    ...
                                    autoComplete="email"
                                    required
                                    className="min-w-0 flex-auto rounded-md border-0 bg-[#DFFF00] px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm sm:leading-6"

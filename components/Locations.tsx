...
export default function Locations() {
  ...
  // Some mobile browsers/webviews can be flaky with IntersectionObserver/whileInView.
  // To avoid content disappearing, only enable scroll animations on md+ screens.
  useEffect(() => {
    const mq = window.matchMedia("(min-width: 768px)");
    const update = () => setEnableScrollAnimations(mq.matches);
    update();
    ...
    <div className="bg-[#333333] py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 overflow-x-hidden">
        ...
        {enableScrollAnimations ? (
          ...
          <div id="find-your-space" className="mx-auto max-w-2xl lg:mx-0">
            {introContent}
          </div>
        )}

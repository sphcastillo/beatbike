...
import newClient from "@/images/newClient.png";
    ...
    return (
      <div className="bg-white h-full">
        <div className="flex min-h-full flex-1 max-w-6xl mx-auto">
          <div className="flex flex-1 flex-col justify-center px-8 py-10 sm:px-10 lg:flex-none lg:px-[100px] xl:px-24">
                    ...
                    <div className="flex items-center justify-between pb-5">
                      {/* <div className="flex items-center">
                        <input
                          ...
                          name="remember-me"
                          type="checkbox"
                          className="h-4 w-4 rounded border-[#DFFF00] text-[#DFFF00] focus:ring-[#DFFF00]"
                        />
